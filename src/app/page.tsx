...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-black">
      <section className="relative flex w-full flex-col items-center justify-center overflow-hidden mobile:h-screen">
        ...
        <div className="absolute bottom-0 flex animate-bounce flex-col items-center pb-16 max-mobile:hidden">
          <Mouse color="#b4b4b4" className=" h-10 w-10" />
          <ChevronsDown color="#b4b4b4" />
        </div>
      </section>

      <section className="flex w-full flex-col bg-white py-12 max-mobile:overflow-x-hidden mobile:py-40">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-8">
          ...
          >
            <div className="relative flex items-center">
              ...
              <p className=" relative text-HB32 max-mobile:font-bold mobile:text-HB60">
                {' '}
                Innovating
                <br className="mobile:hidden" /> Tomorrow
              </p>
            </div>
          </MotionDiv>
          <p className="text-BR12 mobile:text-BR24">
      ...
      <section className="w-full bg-white py-10 mobile:min-h-screen mobile:py-28">
        <div className=" mx-auto flex max-w-7xl flex-col">
          <MotionDiv
            ...
            transition={{ duration: 1, delay: 0.1 }}
          >
            <div className="flex flex-col max-mobile:px-5">
        ...
        {/* 호버 할때 배경변경되는 섹션 */}
        <VoucherMeritBG />
        <div className="dark:bg-grid-white/[0.05] relative flex flex-col overflow-hidden rounded-md bg-white py-0 antialiased dark:bg-black mobile:py-4">
          <InfiniteMovingCards
            items={voucherlogo1}
            direction="left"
            speed="normal"
      ...
      <section className="w-full bg-white">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-28 py-20 mobile:flex-row">
          <MotionDiv
            ...
            initial={{ y: 30, opacity: 0 }}
            transition={{ duration: 1, delay: 0.1 }}
            className="flex flex-col gap-12 max-mobile:px-5"
          >
          ...
          <div className="flex h-[180px] flex-row gap-3 overflow-y-auto scrollbar-hide mobile:h-[960px] mobile:w-[420px] mobile:flex-col mobile:gap-4">
            {pressData.map((e) => (
              <MainNewsCard
                title={e.title}
                day={e.day}
