...
export default function Page() {
  return (
    <main>
      ...
      />
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 px-4 py-20 mobile:gap-20 mobile:px-0 mobile:py-32">
        <div className=" flex w-full flex-col items-start justify-between gap-6 mobile:flex-row mobile:items-center mobile:gap-0">
          <p className="text-BB24 font-bold mobile:text-HB60 mobile:font-extrabold">
            데이터 바우처는 <br /> 무엇일까요?
          </p>
          <p className=" w-full whitespace-normal break-keep text-[14px] font-normal text-[#787878] mobile:w-1/2 mobile:whitespace-pre-line mobile:text-BM20">
...
데이터 구매·가공 바우처를 지원하는 사업입니다.`}
        ...
        <div className=" flex">
          <div className="flex flex-col items-center">
            <div className="h-[80px] w-[80px] mobile:h-[300px] mobile:w-[300px]">
              <Image
            ...
            <p className="py-3 text-BM12 mobile:text-BM20">데이터구축</p>
          </div>
          <div className="h-[38px] w-[38px] py-5 mobile:h-[200px] mobile:w-[200px] mobile:py-16">
            <Image
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="py-3 text-BM12 mobile:text-BM20">가공</p>
          </div>
          <div className="h-[38px] w-[38px] py-5 mobile:h-[200px] mobile:w-[200px] mobile:py-16">
            <Image
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="py-3 text-BM12 mobile:text-BM20">유통</p>
          </div>
        </div>
      </div>
