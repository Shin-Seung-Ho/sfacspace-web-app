...
export default function NewsCard({ src, day, title, content }: NewsCardProps) {
  return (
    <Card className="group/bento row-span-1 flex flex-col justify-between gap-4 space-y-4 rounded-xl border border-transparent bg-white p-4 py-4 shadow-input transition duration-200 hover:shadow-xl dark:border-white/[0.2] dark:bg-black dark:shadow-none">
