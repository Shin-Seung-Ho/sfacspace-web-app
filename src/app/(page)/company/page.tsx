          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-24">
            <div className="flex w-1/2 text-white">
              <div className=" flex w-full items-center gap-20">
                ...
                />
                <p className=" whitespace-pre-line break-keep text-BM20">
            ...
            <div className="ml-auto flex w-1/2  text-white">
              <div className=" flex w-full items-center gap-20 rounded-l-3xl">
                <Image
