...
export default function TopBar() {
  return (
    <header className="sticky top-0 z-30 w-full rounded-b-xl bg-white bg-opacity-30 py-2 backdrop-blur-lg transition duration-500 ease-in-out hover:bg-opacity-100 max-md:hidden">
